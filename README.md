...
Template structure for pre-processing data for human single-neuron projects, including spike sorting.
...
This is a template repository for pre-processing human single-neuron data.
